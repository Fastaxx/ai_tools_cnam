...
::: {.column width="57%"}
![LLMwiki memory](images/obsidian.png){fig-alt="Connected project notes in Obsidian" width="100%" fig-align="center"}
:::
:::
...
::: {.columns}
::: {.column width="33%"}
![](images/climentpdf.png){fig-alt="Reproduction of benchmark from a pdf paper" width="100%" fig-align="center"}
...
::: {.column width="33%"}
![](images/climentpdf2.png){fig-alt="Implementation of the benchmark in our codebase" width="100%" fig-align="center"}
...
::: {.column width="33%"}
![](images/claudeuse1.png){fig-alt="Implementation and verification of large refactoring" width="100%" fig-align="center"}
...
- LLMwiki: <https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f>
